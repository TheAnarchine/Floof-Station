...
job-description-centcomoff = Act as an ambassador to the newest state-of-the-art space station in Floof Station LLC's fleet.
...
job-description-ertleader = Lead the Emergency Response Team in dealing with threats to Floof Station LLC assets.
